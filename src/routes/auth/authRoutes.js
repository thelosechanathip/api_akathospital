...
const { authRegister, authEditUser, authLogin, authVerifyOtp, authVerifyToken, generateSignature, fetchSignature, removeUser, authLogout } = require('../../controllers/auth/authController'); // require AuthController
...
router.post('/fetchSignature', authCheckToken, fetchSignature);
